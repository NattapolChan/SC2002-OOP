...
public class Camp extends CampInformation {
    ...
    /** 
    * Deletes the enquiry from the camp 
    *
    * @param enquiryID 			The ID of enquiry to remove.
    */
    public void deleteCampEnquiry(int enquiryID){
	    campEnquiries.remove(enquiryID);
    }

    /**
     * Retreives the camp suggestions
     *
    ...
    * @param enquiryID 			The ID of enquiry to remove.
    */
    public void deleteCampSuggestion(int enquiryID){
	    campSuggestions.remove(enquiryID);
    }
